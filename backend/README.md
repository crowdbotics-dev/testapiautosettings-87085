...
## Project Structure
    ...
    ├── testapiautosettings_87085  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_87085`
...
2. Clone this repo and `cd testapiautosettings_87085`
